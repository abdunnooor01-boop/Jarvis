...
import { Plus, MessageSquare, Settings, LogOut, User, Puzzle, History } from 'lucide-react'
...
const Sidebar: React.FC<SidebarProps> = ({ onOpenSettings, onOpenPlugins, onOpenTasks }) => {
