...
const ChatScreen = () => {
  ...
  useEffect(() => {
    ...
    voiceService.checkAvailability().then(setVoiceAvailable);
  }, []);
  ...
  const handleVoiceToggle = async () => {
    if (isListening) {
      ...
      if (!started) {
        Alert.alert(
          'Voice Input',
          'Speech recognition is not available on this device. You can type your message instead.',
        );
      }
    }
  };
      ...
      <View style={styles.inputContainer}>
        <View style={styles.inputRow}>
          {voiceAvailable && (
            ...
            >
              <Text style={[styles.voiceIcon, isListening && styles.voiceIconActive]}>
                🎤
              </Text>
            </TouchableOpacity>
          )}
